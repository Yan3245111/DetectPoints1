...
if __name__ == '__main__':
    ...
    spheres, p_bounds, z_bon, y_bon, x_bon = detect_spheres_from_dicom(data=data, pixel_spacing=pixel_spacing, thickness=thickness, pos_ori=pos_ori, output_points=10)
