...
class AppPlanVeri:
    ...
    def cal_plan_ver_dis_angle(self):
        ...
        print(f"model_robot: {model_robot}")
        print(f"rom robot: {rom_robot}")
...
if __name__ == "__main__":
    ...
    import time
    app = AppPlanVeri(npz_file="CT-MP25075-250605-8_2025-06-24_16_15_20.npz")
    time.sleep(1)
